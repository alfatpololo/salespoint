        ...
        <div>
            ...
            <div className="container">
                ...
                <p className="cs_hero_subtitle cs_heading_color cs_heading_font cs_mb_18 text-center">
                    ...
                    <span>Selamat Datang di Salespoint</span>
                    <span className="cs_theme_color_4">
                        <Image src="/assets/img/icons/star-1.svg" alt="img" width={15} height={15}   />
                    </span>
                </p>
                <h1 className="cs_hero_title cs_fs_64 cs_mb_20 wow fadeInDown">Solusi SaaS untuk Memantau <br/> dan Meningkatkan Penjualan Tim Anda</h1>
                <p className="cs_hero_desc cs_mb_26">Platform B2B terdepan untuk memantau performa sales, mengelola pipeline, dan meningkatkan <br/> produktivitas tim penjualan Anda dengan dashboard real-time dan analitik yang powerful</p>
