...
const Blog1 = () => {
    ...
    const blogContent = [
        {img:'/assets/img/post-img-4.jpg', title:'5 Strategi Meningkatkan Performa Tim Sales dengan Dashboard Real-Time', category:'Strategi Sales'},
        {img:'/assets/img/post-img-5.jpg', title:'Cara Memantau Pipeline Penjualan dengan Efektif untuk Perusahaan B2B', category:'Manajemen'},
        {img:'/assets/img/post-img-6.jpg', title:'Tips Meningkatkan Closing Rate dengan Analitik Data yang Akurat', category:'Tips & Trik'},
        {img:'/assets/img/post-img-1.jpg', title:'Mengoptimalkan Workflow Sales dengan Platform Monitoring Terintegrasi', category:'Produktivitas'},
      ];
      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 cs_type_1 cs_mb_60">
          <div className="cs_section_heading_left">
            ...
            <h2 className="cs_section_title cs_fs_48 cs_semibold mb-0 wow fadeInDown">Tips & Insight untuk Meningkatkan Sales</h2>
          </div>
