          ...
          <div className="cs_toolset_text text-center">
            <div className="cs_section_heading cs_style_1 cs_mb_20">
              <div className="cs_section_subtitle cs_fs_18 cs_heading_color cs_mb_22">
                ...
                <span>Integrasi Kami</span>
                <Image src="/assets/img/icons/star-1.svg" alt="img" width={15} height={15}   /> 
              </div>
              <h2 className="cs_section_title cs_fs_48 cs_semibold text-capitalize mb-0 wow fadeInUp">Terintegrasi dengan Tools yang Anda Gunakan.</h2>
            </div>
            <p className="cs_card_desc cs_mb_51">Salespoint terintegrasi dengan berbagai platform populer untuk memudahkan workflow tim sales Anda. Hubungkan dengan tools yang sudah Anda gunakan dan tingkatkan produktivitas.</p>
