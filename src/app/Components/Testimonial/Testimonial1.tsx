...
const Testimonial1 = () => {
    ...
    const testimonialContent = [
        {img:'/assets/img/avatar-5.jpg', subtitle:'Sales Director', title:'Budi Santoso', content:'Salespoint benar-benar mengubah cara kami memantau performa tim sales. Dashboard yang real-time memudahkan kami melihat progress setiap anggota tim dan mengidentifikasi area yang perlu ditingkatkan. Sejak menggunakan Salespoint, produktivitas tim kami meningkat 40% dan kami bisa mencapai target lebih cepat.'},             
        {img:'/assets/img/avatar-6.jpg', subtitle:'CEO Perusahaan', title:'Siti Nurhaliza', content:'Sebagai CEO, saya butuh visibilitas penuh terhadap performa sales tim. Salespoint memberikan insight yang sangat detail dan mudah dipahami. Laporan analitiknya membantu kami membuat keputusan strategis yang lebih baik. Platform ini sangat membantu untuk perusahaan B2B seperti kami.'},             
      ]; 
      ...
      <div className="container">
        <div className="cs_testimonial_slider_wrapper cs_radius_20 position-relative">
          <div className="cs_section_heading cs_style_1 cs_mb_10">
            <h2 className="cs_section_title cs_fs_24 cs_normal mb-0">Testimoni Klien</h2>
          </div>
