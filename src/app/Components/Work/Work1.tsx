          ...
          <div className="col-lg-6 order-lg-2">
            <div className="cs_workink_process_heading cs_center_column position-relative">
              <div className="cs_section_heading cs_style_1 cs_mb_11 z-1">
                ...
                <h2 className="cs_section_title cs_fs_48 cs_semibold wow fadeInUp">Mulai dalam Tiga Langkah Mudah.</h2>
                <p className="cs_card_desc cs_mb_22">Setup cepat dan mudah, langsung mulai memantau performa sales tim Anda dalam hitungan menit.</p>
              </div>
          ...
          <div className="col-lg-6 order-lg-1">
            <div className="cs_iconbox_wrapper_2">
              <div className="cs_iconbox cs_style_2">
                ...
                <h3 className="cs_fs_24 cs_semibold cs_mb_4">Buat Akun Perusahaan</h3>
                <p className="mb-0">Daftar dan buat akun perusahaan Anda dalam hitungan detik. Setup awal yang mudah dan cepat untuk seluruh tim.</p>
              </div>
              <div className="cs_iconbox cs_style_2">
                ...
                <h3 className="cs_fs_24 cs_semibold cs_mb_4">Tambahkan Tim Sales</h3>
                <p className="mb-0">Undang anggota tim sales Anda dan mulai input data penjualan. Integrasikan dengan tools yang sudah Anda gunakan.</p>
              </div>
              <div className="cs_iconbox cs_style_2">
                ...
                <h3 className="cs_fs_24 cs_semibold cs_mb_4">Pantau & Analisis Performa</h3>
                <p className="mb-0">Akses dashboard real-time untuk melihat performa tim, tracking pipeline, dan dapatkan insight untuk meningkatkan penjualan.</p>
              </div>
            </div>
          </div>
        </div>
