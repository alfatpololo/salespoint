        ...
        <div className="row cs_gap_y_30">
          <div className="col-lg-3 col-sm-6">
            <div className="cs_numberbox cs_center_column text-center">
              ...
              <p className="cs_fs_24 cs_white_color mb-0">Perusahaan <br/> Menggunakan</p>
            </div>
          </div>
          <div className="col-lg-3 col-sm-6">
            <div className="cs_numberbox cs_center_column text-center">
              ...
              <p className="cs_fs_24 cs_white_color mb-0">Tim Sales <br/> Terpantau</p>
            </div>
          </div>
          <div className="col-lg-3 col-sm-6">
            <div className="cs_numberbox cs_center_column text-center">
              ...
              <p className="cs_fs_24 cs_white_color mb-0">Deal Berhasil <br/> Ditutup</p>
            </div>
          </div>
          <div className="col-lg-3 col-sm-6">
            <div className="cs_numberbox cs_center_column text-center">
              ...
              <p className="cs_fs_24 cs_white_color mb-0">Kota di <br/> Indonesia</p>
            </div>
          </div>
        </div>
      </div>
