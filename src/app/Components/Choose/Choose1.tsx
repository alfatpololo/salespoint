            ...
            <div className="col-lg-6 order-lg-1">
              <div className="cs_card_content">
                <div className="cs_section_heading cs_style_1 cs_mb_27">
                  ...
                  <h2 className="cs_section_title cs_fs_48 cs_semibold cs_white_color wow fadeInDown">Partner Terpercaya untuk Meningkatkan Performa Sales Tim Anda</h2>
                  <p className="cs_card_desc cs_white_color mb-0">Dengan teknologi canggih dan pengalaman bertahun-tahun, Salespoint membantu ribuan perusahaan meningkatkan efisiensi tim sales, memantau performa real-time, dan mencapai target penjualan lebih cepat.</p>
                </div>
                <ul className="cs_list cs_style_2 cs_white_color cs_semibold cs_mp_0">
                  <li>
                    ...
                    <span>Dashboard real-time untuk monitoring sales</span>
                  </li>
                  <li>
                    <span className="cs_list_icon cs_theme_color_4"><i className="bi bi-check-circle-fill"></i></span>
                    <span>Manajemen pipeline yang mudah dan intuitif</span>
                  </li>
                  <li>
                    <span className="cs_list_icon cs_theme_color_4"><i className="bi bi-check-circle-fill"></i></span>
                    <span>Laporan analitik lengkap dan terperinci</span>
                  </li>
                  <li>
                    <span className="cs_list_icon cs_theme_color_4"><i className="bi bi-check-circle-fill"></i></span>
                    <span>Dukungan tim 24/7 untuk kebutuhan Anda</span>
                  </li>
                </ul>
