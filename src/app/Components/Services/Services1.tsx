 ...
 <section className="position-relative">
      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 cs_mb_47 cs_center_column text-center position-relative z-1">
          ...
          <h2 className="cs_section_title cs_fs_48 cs_semibold mb-0 wow fadeInUp">Fitur Canggih untuk Meningkatkan <br/> Produktivitas Tim Sales Anda</h2>
        </div>
        <div className="cs_features_items_wrapper position-relative z-1">
          <div className="cs_feature_item cs_radius_20 cs_bg_filed" style={{ backgroundImage: `url(${bgImage})`}} >
            <h3 className="cs_fs_36 cs_semibold cs_white_color cs_mb_40">Pantau dan tingkatkan visibilitas <br/> performa sales tim Anda</h3>
          ...
          <ServiceCard1
            ...
            featureList={[
                "Monitoring performa sales harian",
                "Tracking target dan pencapaian",
          ...
          <ServiceCard1
            ...
            featureList={[
                "Tracking deal dari awal hingga closing",
                "Forecasting penjualan akurat",
          ...
          <ServiceCard1
            ...
            featureList={[
                "Laporan performa tim lengkap",
                "Analisis tren penjualan",
                "Insight data yang actionable",
