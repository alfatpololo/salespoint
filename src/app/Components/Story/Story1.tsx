              ...
              <div className="cs_card_content">
                <div className="cs_section_heading cs_style_1 cs_mb_20">
                  <div className="cs_section_subtitle cs_fs_18 cs_heading_color cs_mb_22">
                    ...
                    <span>Kisah Pelanggan</span>
                    <Image src="/assets/img/icons/star-1.svg" alt="img" width={15} height={15}   />
                  </div>
                  <h2 className="cs_section_title cs_fs_48 cs_semibold text-capitalize mb-0 wow fadeInDown">Bagaimana Perusahaan Meningkatkan Performa Sales dengan Salespoint</h2>
                </div>
                <p className="cs_card_desc cs_mb_51">Lihat bagaimana perusahaan-perusahaan di Indonesia berhasil meningkatkan produktivitas tim sales mereka dengan menggunakan platform Salespoint untuk memantau dan mengoptimalkan performa penjualan.</p>
                <div className="cs_btns_group">
                  ...
                  <span>Baca Kisah Pelanggan</span>
                  <span className="cs_btn_icon"><i className="bi bi-arrow-right"></i></span>
                  </a>
                  <div className="cs_client_info_wrapper">
                    <Image src="/assets/img/customers-group-2.png" alt="img" width={182} height={58}   />
                    <div>
                      <h3 className="cs_fs_18 cs_normal mb-0">Pelanggan Puas</h3>
                      <p className="mb-0"><span className="cs_theme_color_5"><i className="bi bi-star-fill"></i></span> 4.8 (10k+ Ulasan)</p>
                    </div>
                  </div>
                </div>
              </div>
